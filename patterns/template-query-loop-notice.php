<?php
/**
 * Title: Rejilla de noticias
 * Slug: newbdtr/template-query-loop-notice
 * Categories: query, newbdtr
 * Block Types: core/query
 * Description: Listado del CPT notice.
 *
 * @package NewBdTr
 */
?>
<!-- wp:query {"query":{"perPage":9,"pages":0,"offset":0,"postType":"notice","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false},"align":"wide","className":"newbdtr-query"} -->
