<?php
/**
 * Title: Rejilla de eventos
 * Slug: newbdtr/template-query-loop-event
 * Categories: query, newbdtr
 * Block Types: core/query
 * Description: Listado del CPT event.
 *
 * @package NewBdTr
 */
?>
<!-- wp:query {"query":{"perPage":9,"pages":0,"offset":0,"postType":"event","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false},"align":"wide","className":"newbdtr-query"} -->
