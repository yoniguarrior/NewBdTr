<?php
/**
 * Title: Rejilla de entradas
 * Slug: newbdtr/template-query-loop
 * Categories: query, newbdtr
 * Block Types: core/query
 * Description: Rejilla de 3 columnas con imagen, fecha, título y extracto. Hereda la consulta.
 *
 * @package NewBdTr
 */
?>
<!-- wp:query {"query":{"perPage":9,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true},"align":"wide","className":"newbdtr-query"} -->
