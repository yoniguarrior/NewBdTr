<?php
/**
 * Title: Rejilla de fotos
 * Slug: newbdtr/template-query-loop-gallery
 * Categories: query, newbdtr
 * Block Types: core/query
 * Description: Listado del CPT gallery.
 *
 * @package NewBdTr
 */
?>
<!-- wp:query {"query":{"perPage":9,"pages":0,"offset":0,"postType":"gallery","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false},"align":"wide","className":"newbdtr-query"} -->
